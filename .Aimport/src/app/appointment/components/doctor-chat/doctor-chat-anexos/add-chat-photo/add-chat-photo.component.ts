...
@Component({
  selector: 'app-add-chat-photo',
  templateUrl: './add-chat-photo.component.html',
  styleUrls: ['./add-chat-photo.component.scss']
})
export class AddChatPhotoComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<AddChatPhotoComponent>,) { }
