...
export class VisualizarAtestadoComponent implements OnInit {
  ...
  constructor(private appointmentService: AppointmentService, 
    ...
    public dialogRef: MatDialogRef<VisualizarAtestadoComponent>) { 
  ...
  getCertificateById() {
    this.appointmentService.getCertificateById(this.cert_id, this.token).subscribe(
      data => {
